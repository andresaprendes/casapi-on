...
async function setupWebhookSchemaProduction() {
  try {
    console.log('🔧 Setting up webhook schema in production...');
    ...
    console.log('🎉 Webhook schema setup completed successfully in production!');
...
// Run the setup
setupWebhookSchemaProduction().catch(console.error);
